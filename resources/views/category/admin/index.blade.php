...
@include('layouts.sidebar', ['admin' => true, 'active' => 'category'])
...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            @include('layouts.breadcrumb', ['admin' => true, 'pageTitle' => 'Category', 'hasBack' => true, 'backTitle' => 'Dashboard', 'backUrl' => route('admin.dashboard')])
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-between">
                            ...
                            <a href="{{ route('admin.category.create') }}" class="btn btn-primary float-right">Add New Category</a>
                        </div>
                                                ...
                                                <div class="tab-pane active" id="tab5">
                                                    <div class="table-responsive">
                                                        <div id="data-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                                                    ...
                                                                    <thead class="border-top">
                                                                        <tr>
                                                                            <th class="bg-transparent border-bottom-0"
                                                                                style="width: 5%;">Category Name</th>
                                                            ...
                                                            {{ $auctiontypes->links('pagination.admin') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
