...
@section('title', 'Admin Auction Type Edit')
@section('content')
...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            @include('layouts.breadcrumb', ['admin' => true, 'pageTitle' => 'Auction Type', 'hasBack' => true, 'backTitle' =>
                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">All Auction Type Edit</h3>
                        </div>
                    </div>
                </div>
            </div>
